...
class CarsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('foto', function ($row) {
                return view('cars.foto', compact('row'));
            })
            ->addColumn('Ketersedian', function ($row) {
                return view('cars.ketersediaan', compact('row'));
            })
    ...
    public function getColumns(): array
    {
        return [
            Column::make('merk'),
            Column::make('model'),
            Column::computed('Plat'),
            Column::make('tarif'),
            Column::computed('Ketersedian'),
